...
class Example
{
    private int $readCounter = 0; // error: Property PropertyHooks7\Example::$readCounter is never written // error: Property PropertyHooks7\Example::$readCounter is never read
