...
final class DeadCodeRuleTest extends ShipMonkRuleTestCase
{
    ...
    public static function provideFiles(): Traversable
    {
        ...
        yield 'property-promoted-hook' => [__DIR__ . '/data/properties/promoted-hook.php', self::requiresPhp(8_04_00)];
        yield 'property-promoted-parent' => [__DIR__ . '/data/properties/promoted-parent.php', self::requiresPhp(8_04_00)];
        yield 'property-promoted-parent-2' => [__DIR__ . '/data/properties/promoted-parent-2.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-1' => [__DIR__ . '/data/properties/hooks-1.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-2' => [__DIR__ . '/data/properties/hooks-2.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-3' => [__DIR__ . '/data/properties/hooks-3.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-4' => [__DIR__ . '/data/properties/hooks-4.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-5' => [__DIR__ . '/data/properties/hooks-5.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-6' => [__DIR__ . '/data/properties/hooks-6.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-7' => [__DIR__ . '/data/properties/hooks-7.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-8' => [__DIR__ . '/data/properties/hooks-8.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-9' => [__DIR__ . '/data/properties/hooks-9.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-10' => [__DIR__ . '/data/properties/hooks-10.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-11' => [__DIR__ . '/data/properties/hooks-11.php', self::requiresPhp(8_04_00)];
        yield 'property-hooks-12' => [__DIR__ . '/data/properties/hooks-12.php', self::requiresPhp(8_04_00)];
