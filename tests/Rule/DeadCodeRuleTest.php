...
use ShipMonk\PHPStan\DeadCode\Provider\LaravelTestLifecycleUsageProvider;
...
final class DeadCodeRuleTest extends ShipMonkRuleTestCase
{
    ...
    public static function provideFiles(): Traversable
    {
        ...
        yield 'provider-laravel-test-lifecycle' => [__DIR__ . '/data/providers/laravel-test-lifecycle.php'];
    ...
    private function getMemberUsageProviders(): array
    {
        ...
        $provides = [
            ...
            new LaravelTestLifecycleUsageProvider(
                $this->providersEnabled,
            ),
