...
final class ChangeVisibilityTransformer
{
    ...
    private PhpTraverser $changingTraverser;
    ...
    )
    {
        ...
        $this->changingTraverser = new PhpTraverser();
        $this->changingTraverser->addVisitor(new ChangeVisibilityVisitor($visibilityChanges));
    ...
    public function transformCode(string $oldCode): string
    {
        ...
        $newAst = $this->changingTraverser->traverse($this->cloningTraverser->traverse($oldAst));
